...
GRANT ALL ON FUNCTION "public"."atualizar_etapas_instalacao"("p_projeto_id" bigint, "p_etapas_instalacao" "text") TO "anon";
...
GRANT ALL ON FUNCTION "public"."atualizar_status_instalacao"("p_projeto_id" bigint, "p_novo_status" "text") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_os_operacional_instalador"("p_projeto_id" bigint) TO "anon";
...
GRANT ALL ON FUNCTION "public"."registrar_evidencia_instalacao"("p_projeto_id" bigint, "p_nome_arquivo" "text", "p_url_arquivo" "text") TO "anon";
...
GRANT ALL ON TABLE "public"."_bkp_os_instaladores_f4a002_meta" TO "anon";
GRANT ALL ON TABLE "public"."_bkp_os_instaladores_f4a002_meta" TO "authenticated";
