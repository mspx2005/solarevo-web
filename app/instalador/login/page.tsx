...
export default function LoginInstaladorPage() {
  ...
  // Não alterada nesta tarefa. Valida role "instalador" e usuário ativo.
  // ===========================================================================
  async function handleLogin(e: React.FormEvent) {
    ...
    if (profile.role !== "instalador") {
      await supabase.auth.signOut();
      setErro("Acesso restrito ao perfil de Instalador.");
      setCarregando(false);
      return;
    }
    ...
    <main className="flex min-h-screen items-center justify-center bg-enertrack-slate-950 px-4 py-10">
      <div className="w-full max-w-md rounded-2xl border border-white/5 bg-enertrack-slate-800 p-8 shadow-2xl shadow-black/40">
        ...
        <div className="mb-8 text-center">
          ...
          <span className="mt-2 inline-flex items-center rounded-full bg-enertrack-blue-accent/15 px-3 py-1 text-xs font-semibold text-enertrack-blue-accent ring-1 ring-enertrack-blue-accent/30">
